...
INSERT INTO "new_Post" ("authorId", "content", "coverImage", "excerpt", "id", "published", "slug", "title") SELECT "authorId", "content", "coverImage", "excerpt", "id", "published", "slug", "title" FROM "Post";
DROP TABLE "Post";
